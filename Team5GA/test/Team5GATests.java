...
import team5ga.City;
import team5ga.Configuration;
import team5ga.GA;
import team5ga.Population;
import team5ga.Route;

/**
 *
 * @author Avee Arora
 */
public class Team5GATests {

    @Test
    public void TSP() {
        Population evlovedPopulation = team5ga.Team5GA.TSP(Configuration.numberOfCities, Configuration.numberOfPopulation, Configuration.numberOfEvolution, true);
    ...
    public void randomCheckAfterMutation() {
        Population evlovedPopulation = team5ga.Team5GA.TSP(10, 20, 1, false);
        Random r = new Random();
        HashMap<City, String> checkCities = new HashMap<City, String>();
        boolean nullFlag = false;
